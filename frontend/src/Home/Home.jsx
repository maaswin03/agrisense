        ...
        <div>
            ...
            <div className='home27'>
                <div className='home28'>
                    <h2>AgriSense</h2>
                    <p>REVOLUTIONIZING PLANT MANAGEMENT AND ENHANCING FARMING EFFICIENCY</p>
            ...
            <div className='home5'>
                <h2>Latest News</h2>
                <div className='home6'>
                    <div className='home7' style={{width:'30%',height:'500px'}}>
